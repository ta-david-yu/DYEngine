    ...
    result.append(ComponentTypeRegistrationCallSourceStart);
    {
        ...
        result.append(DrawInspectorLambdaSourceStart);
        {
            ...
            for (auto const &useWithComponentTypeName: descriptor.UseWithComponentTypeHints)
            {
                ...
                drawMissingComponentWarningSource = std::regex_replace(drawMissingComponentWarningSource, useWithComponentTypeNameWithReplacedNamespaceSymbolKeywordPattern,
                                                                       useWithComponentTypeNameWithReplacedNamespaceSymbol);
