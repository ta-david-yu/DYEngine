...
namespace DYE
{
	void LetsGoCoolThemeByRedNicStone()
	{
		...
		style.Colors[ImGuiCol_TabUnfocusedActive] = ImVec4(0.000f, 0.253f, 0.425f, 1.000f);
		...
		style.Colors[ImGuiCol_DragDropTarget] = ImVec4(0.546f, 1.000f, 0.508f, 1.000f);
		style.Colors[ImGuiCol_NavHighlight] = ImVec4(0.1450980454683304f, 0.1450980454683304f, 0.1490196138620377f, 1.0f);
		style.Colors[ImGuiCol_NavWindowingHighlight] = ImVec4(1.0f, 1.0f, 1.0f, 0.699999988079071f);
		style.Colors[ImGuiCol_NavWindowingDimBg] = ImVec4(0.800000011920929f, 0.800000011920929f, 0.800000011920929f, 0.2000000029802322f);
		style.Colors[ImGuiCol_ModalWindowDimBg] = ImVec4(0.000f, 0.000f, 0.000f, 0.725f);
	}
